...
<form class="form-horizontal" action="<c:url value='/register'/>" method="POST">
  <fieldset>
   ...
   <!--  <div class="control-group">
      ...
      <div class="controls">
        <input type="password" id="password_confirm" name="password_confirm" placeholder="Password (Confirm)" class="input-xlarge" required>
    ...
    <label class="control-label" for="phone_number">Phone Number</label>
      ...
      <input type="text" id="p_number" name="phoneNo" placeholder="Phone Number" class="input-xlarge" required>
      </div>
    </div>
